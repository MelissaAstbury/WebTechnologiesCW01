...
(() => {
  ...
  // config.ts
  var API_KEY = "AIzaSyDBLXIqYFKM6tuqgfSjBD-ZWhdxQisYwg4";
  var DATABASE_URL = "https://peliza-recipes-default-rtdb.firebaseio.com";
  var APP_ID = "1:970097814588:web:49d8ea7ba4b815985e6739";
  var MESSAGING_SENDER_ID = "970097814588";
  var MEASUREMENT_ID = "G-1EBBGYCJ11";
  ...
  var recipeForm = getDatabase(app);

  // src/ts/auth.ts
  var onSignInWithGoogle = () => __async(void 0, null, function* () {
    try {
  ...
  var _a;
  (_a = document.getElementById("recipe-form")) == null ? void 0 : _a.addEventListener("submit", createRecipe);
  var createRecipeBtn = document.querySelector(
    "#save-btn"
  );
